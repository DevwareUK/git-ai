...
| `prs review tests` | Finds the highest-value automated testing gaps in the repository. |
...
- `prs issue <number> <number> [...number]`
- `prs issue batch <number> <number> [...number]` (compatibility alias)
- `prs pr prepare-review <pr-number>`
- `prs pr resolve-conflicts <pr-number>`
- `prs review features`
- `prs feature-backlog` (compatibility alias)
...
- `prs review tests`: find high-value automated testing gaps
...
- `prs test-backlog` and `prs feature-backlog`: compatibility aliases for the review subcommands
...
Compatibility alias: `prs test-backlog` accepts the same options.
...
Compatibility alias: `prs feature-backlog` accepts the same options.
...
- `prs review features` prints a beta workflow notice before execution; `prs feature-backlog` also prints a compatibility-framed beta notice
...
| `pnpm cli:feature-backlog -- <args>` | Builds the CLI package and runs compatibility alias `prs feature-backlog <args>`. |
...
| `pnpm cli:review-features -- <args>` | Builds the CLI package and runs `prs review features <args>`. |
| `pnpm cli:review-tests -- <args>` | Builds the CLI package and runs `prs review tests <args>`. |
| `pnpm cli:test-backlog -- <args>` | Builds the CLI package and runs compatibility alias `prs test-backlog <args>`. |
...
| `packages/cli` | `pnpm --filter @prs/cli feature-backlog -- <args>` | Builds the CLI package and runs compatibility alias `node dist/index.js feature-backlog <args>`. |
...
| `packages/cli` | `pnpm --filter @prs/cli review-features -- <args>` | Builds the CLI package and runs `node dist/index.js review features <args>`. |
| `packages/cli` | `pnpm --filter @prs/cli review-tests -- <args>` | Builds the CLI package and runs `node dist/index.js review tests <args>`. |
